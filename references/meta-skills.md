...
|---|---|---|
| `/sales-launch-directory` | Startup directory launches | Open Launch, CtrlAlt.cc, ProductBurst, SoloPush, MicroLaunch, LaunchingNext, SideProjectors, Product Hunt, BetaList, Hacker News, Indie Hackers |
