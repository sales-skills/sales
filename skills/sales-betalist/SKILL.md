...
|---|---|---|---|---|
| Free | $0 | ~1 week notification, ~2 months until featured | Not guaranteed | Yes (~2 months) |
| Priority | $129 | Reviewed within days | Guaranteed if accepted | Skip the queue |

**Refunds:** Full refund auto-processed for rejected Priority submissions (5-10 business days). No refunds once featured.
...
BetaList offers API access on a case-by-case basis:
- Email api@betalist.com with: intended use, use case description, estimated request volume
- If approved, you receive an API key and access to documentation (hosted on GitHub Gist)
