...
- `/sales-sybill` — Sybill platform help (CRM Autofill, Deal Workspace, Ask Sybill, Magic Summaries)
...
- `/sales-weflow` — Weflow platform help (Salesforce-native Revenue AI with activity capture, conversation intelligence, deal forecasting)
