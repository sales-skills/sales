...
- **"Tomba" / "Tomba.io" / "domain search" / "email finder" / "email verifier" / "author finder" / "LinkedIn finder" / "phone finder" / "email format" / "email pattern"** → `/sales-tomba` (platform help). If asking about enrichment strategy across tools → `/sales-enrich`. If asking about building a prospect list → `/sales-prospect-list`. If asking about email deliverability/verification strategy → `/sales-deliverability`. If asking about connecting Tomba to other tools → `/sales-integration`.
