...
For platform-specific funnel building guidance (Groove.cm, ClickFunnels, GoHighLevel, Kartra, WordPress, Closum, Mailchimp, GetResponse, Kit, SendPulse, VWO, Leadpages, Unbounce, etc.), see references/platforms.md.
