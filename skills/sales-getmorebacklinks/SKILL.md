...
- `/sales-launch-directory` — DIY directory submission strategy across 30+ platforms. Covers which directories to submit to, in what order, and how to optimize listings. Install: `npx skills add sales-skills/sales --skills sales-launch-directory`
