...
- `/sales-medallia` — Medallia platform help (Experience Cloud, DXA, contact center, APIs) — the main enterprise alternative to Qualtrics. Install: `npx skills add sales-skills/sales --skill sales-medallia`
