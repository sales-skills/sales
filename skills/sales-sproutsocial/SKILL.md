...
description: "Sprout Social platform help — Publishing, Smart Inbox, Analytics, Social Listening (add-on), Influencer Marketing, Employee Advocacy, AI Assist, API, Salesforce/HubSpot/Zendesk integrations. Use when configuring Sprout Social, managing social publishing, setting up Smart Inbox, building analytics reports, configuring social listening queries, managing influencer campaigns in Sprout, enabling employee advocacy, using AI Assist, connecting Sprout to CRM, troubleshooting account disconnections, or comparing Sprout Social vs Hootsuite/Buffer/Agorapulse. Do NOT use for social listening strategy across tools (use /sales-social-listening), influencer marketing strategy (use /sales-influencer-marketing), social media management strategy (use /sales-social-media-management), or employee advocacy strategy (use /sales-employee-advocacy)."
