...
- SEO/backlink strategy beyond directories → use Semrush or relevant SEO skill
- Email marketing to subscribers → `/sales-email-marketing`

Otherwise, answer directly from the platform reference below.

## Step 3 — Startup Stash platform reference
...
| Type | Curated startup tool directory |
| Founded by | Bram Kanstein (acquired by Israeli media company, Nov 2017) |
| Scale | 10,000+ tools, 200+ categories |
| Monthly traffic | ~10K visits |
| Domain Rating | DR65 / Moz DA45 |
| Backlink type | **Nofollow** |
| Submission cost | Free |
| Curation | Selective — not every submission is accepted |
| Newsletter | "STASH!" weekly newsletter |
| Product Hunt history | #1 most upvoted product of all time on Product Hunt |
| Contact | hello@startupstash.com |

### Submission process

1. **Go to** startupstash.com/add-listing/
2. **Create an account** on Startup Stash
3. **Fill out your product details** — name, description, category, URL, screenshots
4. **Submit for review** — curation team reviews submissions manually
5. **Wait for approval** — turnaround time varies (days to weeks)
...
|---|---|---|
| Domain Rating | DR65 | Solid |
| Backlink type | Nofollow | Limited direct SEO value |
| Monthly traffic | ~10K | Modest referral traffic |
| Category relevance | High (startup audience) | Good for brand visibility |
...
- Pricing is not publicly listed — contact hello@startupstash.com
...
|---|---|---|---|---|---|
| **Startup Stash** | DR65 | Nofollow | Free | Selective review | Brand visibility, large directory |
| SideProjectors | DR69 | Dofollow | Free | Editorial review | SEO + marketplace |
| BetaList | DR67 | Dofollow | Free / $129 skip | Editorial queue | Pre-launch products |
| Open Launch | DR65 | Dofollow | Free / $12 premium | Queue / instant | SEO backlinks |
| F6S | DR74 | Dofollow | Free | Varies | EU markets, accelerators |
...
1. **Category selection** — browse existing categories at startupstash.com/categories/ to find the best fit. Being in the right category matters for discovery.
2. **Description** — lead with the problem you solve, not features. Keep it concise — directory browsers scan, they don't read.
3. **Screenshots** — show the product in action. Not marketing graphics — actual UI screenshots.
4. **URL** — make sure your landing page has a clear CTA and works well on first load.
...
**Skill does**:
1. Confirms the product fits Startup Stash's criteria (established tool, clear category)
2. Walks through the submission process at startupstash.com/add-listing/
3. Recommends category selection and listing optimization tips
4. Sets expectations: nofollow backlink, selective review, variable turnaround
5. Suggests parallel submission to dofollow directories for SEO value
...
**Skill does**:
1. Explains nofollow vs dofollow — Startup Stash links are nofollow
2. Compares with dofollow alternatives (Fazier DR81, Uneed DR74, SideProjectors DR69)
3. Recommends submitting anyway (free, credibility signal) but deprioritizing vs dofollow options
4. Points to `/sales-launch-directory` for full backlink stacking strategy
**Result**: Clear understanding of SEO value with actionable priority list
...
**Skill does**:
1. Explains the advertising partnership program
2. Notes pricing is not public — contact hello@startupstash.com
3. Warns about reported payment-after-submission experience
4. Suggests alternatives with transparent pricing (Fazier, Open Launch, DevHunt)
