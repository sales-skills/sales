---
name: sales-tinylaunch
description: "TinyLaunch platform help — weekly product launch platform for indie makers (Product Hunt alternative). Covers free submission (DR60-71 dofollow backlink for Top 3), $39 premium launch (skip queue, guaranteed dofollow backlink), weekly badge system, newsletter sponsorship ($50/issue to ~11,000 subscribers), featured spot placement ($15-$30/week), submission service (50-100 directories), and feedback/review services. Use when submitting to TinyLaunch, evaluating TinyLaunch backlink value, choosing between free and premium launch, or comparing TinyLaunch with other directories. Do NOT use for multi-directory launch strategy (use /sales-launch-directory). Do NOT use for Product Hunt launches (use /product-hunt-launch)."
argument-hint: "[describe what you need help with on TinyLaunch]"
license: MIT
version: 1.0.0
...
|---|---|
| URL | tinylaunch.com |
| Founder | Christopher Woggon (@chrissyinspace) |
| Model | Weekly launch cycles + rankings |
| Free submission | Yes — dofollow backlink for Top 3 |
| DR | 60-71 (sources vary; LaunchDirectories reports DR71) |
| DA | 21 (Moz) |
| Backlink (free) | Dofollow (Top 3 weekly only — badge must link to TinyLaunch) |
| Backlink (paid) | Dofollow — guaranteed with $39 premium launch |
| Newsletter | ~11,000 subscribers (Beehiiv), 33% open rate |
| Users | 22,000+ claimed |
| Categories | Productivity, Developer Tools, Health & Wellness, AI & Machine Learning, SaaS & Tools, Marketing & Sales, E-commerce, Social Media, Web3 & Blockchain, Finance & FinTech, Community & Networking |
| Revenue | ~$3K/mo MRR (public, shared on Substack/X) |
| API | None public |
...
|---|---|---|
| Standard Launch | Free | Homepage for multiple days, badge + dofollow backlink if Top 3 |
| Premium Launch | $39/launch | Skip queue, guaranteed dofollow backlink, showcased between 3rd and 4th place |
| Newsletter Sponsorship | $50/issue | Featured placement to ~11,000 subscribers (33% open rate) |
| Top Featured Spot | $30/week | Top of feed placement |
| Mid-Feed Spot | $15/week | Mid-feed featured placement |
| Submission Service (50 dirs) | $179 | Submit to 50 directories + report |
| Submission Service (100 dirs) | $279 | Submit to 100 directories + report |
| Private Feedback | $249 | Detailed product feedback |
| Public Review | $399 | Published product review |
| Feedback + Review Combo | $550 | Both private feedback and public review |

### Key features

| Feature | Description |
|---|---|
| Weekly launches | Products compete in weekly batches — slower pace gives each launch more visibility |
| Top 3 badges | Winners receive badges for social proof + dofollow backlink |
| Premium placement | $39 guaranteed backlink + queue skip — shown between 3rd and 4th place |
| Newsletter | ~11,000 subscribers, 33% open rate — sponsorship available at $50/issue |
| Featured spots | $15-$30/week for prominent feed placement |
| Submission service | Pay TinyLaunch to submit your product to 50-100 other directories |

### Submission process

1. **Create an account** at tinylaunch.com
2. **Prepare materials** — product name, description, screenshots, working product URL
3. **Submit your product** — choose Standard (free) or Premium ($39)
4. **Wait for launch window** — products launch in weekly batches (Premium skips queue)
5. **Engage during launch week** — respond to feedback, share on social
6. **If Top 3** — receive badge + dofollow backlink (badge must embed link to TinyLaunch)

### How TinyLaunch compares

| Aspect | TinyLaunch | Open Launch | Tiny Startups | DevHunt | ProductBurst |
|---|---|---|---|---|---|
| DR | 60-71 | 65 | 50 | 57-62 | 46 |
| Backlink type | Dofollow (Top 3 or $39) | Dofollow (conditional) | Dofollow | Dofollow | Dofollow |
| Queue | Weekly batches | Queue (free) / next day ($12) | Weekly curation | None — instant | None — instant |
| Paid option | $39 premium launch | $12 premium / $59 SEO | Not public | $49 featured | One-time featured |
| Newsletter | Yes (~11K subs, $50 sponsor) | No | Yes (17,500+ subs) | Yes | No |
| Focus | Indie makers | All startups | Bootstrapped founders | Developer tools only | All startups |

### When TinyLaunch makes sense

**Good fit:**
- You're an indie maker or early-stage startup
- You want a high-DR dofollow backlink (DR60-71 is among the strongest free directories)
- You're willing to compete for Top 3 or pay $39 for guaranteed backlink
- You want newsletter exposure to ~11,000 subscribers
- You prefer a slower weekly cadence with less competition per launch window

**Not ideal:**
- You need an instant listing — TinyLaunch uses weekly launch batches with a queue
- You need a guaranteed free backlink — free tier only gives backlinks to Top 3
- You need the highest traffic — organic traffic is modest (~87/mo per LaunchDirectories, likely undercounted)
- You're not willing to actively promote your launch during the voting window
...
1. Create an account at tinylaunch.com
2. Prepare: clear product name, problem-focused tagline, screenshots, working product URL
3. Add UTM tracking: `?utm_source=tinylaunch&utm_medium=directory&utm_campaign=launch`
4. **Aim for Top 3** — only Top 3 get the dofollow backlink on free tier. Promote your launch on X/Twitter, especially within the indie maker community where TinyLaunch has strong presence
5. **Embed the badge properly** — the dofollow backlink requires your badge to link back to TinyLaunch's homepage
6. Submit early in the week — weekly batches mean timing affects competition level
...
- **Free backlinks are conditional.** Only Top 3 weekly launches get the dofollow backlink on free tier. If you don't make Top 3, you get no backlink (unlike platforms where every submission gets a backlink).
- **Badge linking requirement.** The dofollow backlink requires your Top 3 badge to embed a link back to TinyLaunch's homepage. If you remove or modify the badge link, you may lose the backlink.
- **DR varies significantly by source.** LaunchDirectories reports DR71, other sources report DR60. Treat it as "high 60s to low 70s" — either way, it's among the strongest directory backlinks.
- **Weekly cadence means waiting.** Unlike instant-listing platforms, you'll wait for the next weekly launch window. Premium ($39) skips the queue but still launches in a batch.
...
**Skill does**:
1. Walks through the submission process
2. Explains Top 3 requirement for free dofollow backlink
3. Recommends promoting on X/Twitter during voting window
4. Suggests $39 Premium if guaranteed backlink is important
5. Notes the DR60-71 backlink value
...
**Skill does**:
1. Shows DR60-71 dofollow — among the highest directory backlinks
2. Compares: Open Launch (DR65), DevHunt (DR57-62), MicroLaunch (DR59), SoloPush (DR46)
3. Notes the conditional nature (Top 3 only for free) vs guaranteed ($39)
4. Recommends $39 Premium as strong DR-per-dollar value
...
**Skill does**:
1. Explains ~11,000 subscribers with 33% open rate (~3,600 opens)
2. Calculates CPM: ~$4.55 per 1K subscribers, ~$13.89 per 1K opens
3. Compares with Tiny Startups newsletter (17,500+ subs, pricing not public)
4. Recommends if product targets indie makers and early-stage founders
...
**Solution**: Verify your badge HTML includes a proper `<a href>` link to tinylaunch.com with no `nofollow` attribute. Wait 2-4 weeks for crawlers to index. DR60-71 domains get crawled regularly.
